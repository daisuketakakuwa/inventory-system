...
import (
	"context"
	inventorysvr "inventory-system/gen/http/inventory/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, inventoryEndpoints *inventory.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
